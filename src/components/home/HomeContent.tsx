...
function Sidebar({ active, onSelect }: { active: string | null; onSelect: (p: string | null) => void }) {
  return (
    <aside className="hidden xl:flex w-52 shrink-0 sticky top-16 self-start h-[calc(100vh-4rem)] flex-col overflow-y-auto border-r border-slate-200/50 bg-white/60 px-4 py-6 backdrop-blur-sm">
