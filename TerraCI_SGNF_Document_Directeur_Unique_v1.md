...
- **Dette résiduelle faible, notée :** `FileValidation` `.in("id", lotIds)` casserait sur une soumission d'import massive ; pagination à prévoir le jour où `documents`/`attestations` dépassent 1000. Livré : `sgfn-deploy-20260718-audit-dashboards.tar.gz` (front à uploader cPanel).
